...
function MessageDraft() {
    ...
    return (
        <div className="flex flex-col p-8 pb-0">
            ...
            <div className="mt-4 overflow-auto lg:h-[725px]">
                        ...
                        {tableData.map((data, key) => {
                            return (
                                <TableRow key={key}>
                                    ...
                                    <TableCell className="max-w-[15rem] whitespace-nowrap overflow-hidden text-ellipsis" >{data.subject}</TableCell>

                                    {/* <TableCell className="text-[#039adf]"><i className="fa-solid fa-envelope text-gray-400"></i> {data.source}</TableCell> */}
                                    <TableCell className="text-[#039adf]">{data.email}</TableCell>


                                    <TableCell>
                                        <Badge
                                            className={"rounded-md bg-red-200 text-red-800"}
                                            variant="primary"
                                        >
                                            {data.draft}
                                        </Badge>
